...
<div class="alert alert-danger">
    <i class="fa fa-exclamation-triangle"></i> <?php echo $_SESSION['alert-msg']; ?>
</div>
<?php } ?>
            ...
            foreach ($rows as $row) {
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a data-href="<?php echo base_url('dashboard/accounts/delete/'.$row->id.'')?>" id="<?php echo $row->id?>" data-toggle="modal" data-target="#confirm-delete" href="#" class="label label-danger"><i class="fa fa-trash"></i></a>
                    </td>
                </tr>
            <?php }} ?>
        </table>
