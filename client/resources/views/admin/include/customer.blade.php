...
@section('content')
    ...
    <div class="box box-info">
        ...
        <div class="box-body">
            <a data-toggle="modal" data-target="#confirm-delete" href="#"  class="label label-success"><i class="fa fa-user-plus"></i> Add New</a>
         ...
         <span ng-if="customer != 'false'">
            <table class="table table-bordered">
                <tr><th>Firstname</th><th>E-mail</th><th>City</th><th>Action</th><th>Status</th></tr>
                <tr ng-repeat="row in customer|filter: search">
                    ...
                    <td>
                        ...
                        <a href="#" ng-click="view(row.active)" class="label label-info">View</a>
                    </td>
                    <td>
